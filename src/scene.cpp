...
namespace RT_ISICG
{
	...
	void Scene::init()
	{
		...
		_addObject( new ImplicitTorus( "Sphere2", Vec3f( 0.f, 2.f, 3.f ), 1.f, 0.2f ) );
		...
		_addObject( new Mandlebulb( "Torus", Vec3f( 0.f, 0.f, 3.f ) ) );
		_attachMaterialToObject( "GreyMatte", "Torus" );
