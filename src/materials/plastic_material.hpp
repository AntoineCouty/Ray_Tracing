...
namespace RT_ISICG
{
	...
	{
	  public:
		PlasticMaterial( const std::string & p_name, const Vec3f & p_diffuse, float p_s )
		...
		inline const Vec3f & getFlatColor() const override { return _brdfLambert.getKd() * 0.7f + _brdfPhong.getKd() * 0.3f; }
